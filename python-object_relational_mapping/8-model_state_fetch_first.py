...
It connects to the MySQL database using SQLAlchemy and retrieves the first entry from the states table.
"""
...
if __name__ == "__main__":
    ...
    # Check if a state is found and display the result
    if state:
